...
router.patch('/api/admin/users/:id/role', (req, res) => adminController.updateUser(req, res, 'role'));
router.patch('/api/admin/users/:id/status', (req, res) => adminController.updateUser(req, res, 'is_active'));
